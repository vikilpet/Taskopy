...
- **event_log** (None) - название журнала Windows (System, Application, Security, Setup), т.е. выполнять задачу при новых событиях в этом журнале. Для тестирования можно создать новое событие в журнале *Application* в консоли:
