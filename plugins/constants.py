...
DATE_STR_ISO_MCS = '%Y-%m-%dT%H:%M:%S.%f'
DATE_STR_ISO = '%Y-%m-%dT%H:%M:%S'
DATE_STR_ISO_FILE = '%Y-%m-%dT%H-%M-%S'
...
VK_OEM_6      = 0xDD   # ] }
VK_OEM_7      = 0xDE   # ' "
VK_OEM_102    = 0xE2   # Extra key (often < > or \ on non-US keyboards)
THREAD_PRIORITY = {
	win32con.THREAD_PRIORITY_IDLE:          'THREAD_PRIORITY_IDLE (-15)',
	win32con.THREAD_PRIORITY_LOWEST:        'THREAD_PRIORITY_LOWEST (-2)',
	win32con.THREAD_PRIORITY_BELOW_NORMAL:  'THREAD_PRIORITY_BELOW_NORMAL (-1)',
	win32con.THREAD_PRIORITY_NORMAL:        'THREAD_PRIORITY_NORMAL (0)',
	win32con.THREAD_PRIORITY_ABOVE_NORMAL:  'THREAD_PRIORITY_ABOVE_NORMAL (1)',
	win32con.THREAD_PRIORITY_HIGHEST:       'THREAD_PRIORITY_HIGHEST (2)',
	win32con.THREAD_PRIORITY_TIME_CRITICAL: 'THREAD_PRIORITY_TIME_CRITICAL (15)',
}
